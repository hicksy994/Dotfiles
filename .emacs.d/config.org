  ...
  ((string= my-theme 'gruvbox)
   (use-package gruvbox-theme
     ...
     (custom-theme-set-faces
      ...
      '(mode-line-inactive ((t(:foreground "#d5c4a1" :background "#504945" :weight bold))))
      '(powerline-active1 ((t(:foreground "#d5c4a1" :background "grey22" :weight bold))))
      '(powerline-inactive1 ((t(:foreground "#d5c4a1" :background "grey22" :weight bold))))
      '(powerline-active2 ((t(:foreground "#d5c4a1" :background "grey40" :weight bold))))
      '(powerline-inactive2 ((t(:foreground "#d5c4a1" :background "grey40" :weight bold))))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package cmake-ide
    ...
    (require 'rtags)
    (cmake-ide-setup)
    (setq cmake-ide-build-dir "~/projects/c/HackerRank/build"))
